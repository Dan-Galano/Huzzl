...
Widget buildBranchesContent(BuildContext context) {
  return StatefulBuilder(
    builder: (context, setState) {
      // Initialize the TabController inside the StatefulBuilder
      TabController _tabController = TabController(length: 2, vsync: Scaffold.of(context)); 
                ...
                children: [
                  LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      double textFieldWidth = screenWidth * 0.4;
                  ...
                  TabBar(
                    ...
                    unselectedLabelStyle: const TextStyle(
                      ...
                      fontWeight: FontWeight.normal, // Font weight of the unselected tabs
                      fontFamily: 'Galano', // Use your custom font
                    ),
                    tabs: const [
                      Tab(text: '4 Active'),
