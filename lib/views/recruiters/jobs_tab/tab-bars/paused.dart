...
class PausedJobs extends StatefulWidget {
  final User user;
  final List<Candidate> candidates;
  const PausedJobs({super.key, required this.user, required this.candidates});

  @override
  State<PausedJobs> createState() => _PausedJobsState();
}

class _PausedJobsState extends State<PausedJobs> {
  @override
                ...
                if (snapshot.data!.docs.isEmpty) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      const Gap(20),
                      const Text(
                        "Job posts that have been paused will appear here.",
                        style: TextStyle(
                          fontSize: 16,
                          color: Colors.grey,
                        ),
                  ...
                  final openJobs = jobPostsData
                      .where(
                        (jobPost) => jobPost.containsValue('paused'),
                      )
                      .toList();
                  if (openJobs.isEmpty) {
                    return Column(
