...
class ActiveBranchCard extends StatefulWidget {
  final Branch branch;

  const ActiveBranchCard({Key? key, required this.branch}) : super(key: key);

  @override
  State<ActiveBranchCard> createState() => _ActiveBranchCardState();
}

class _ActiveBranchCardState extends State<ActiveBranchCard> {
                            ...
                            content: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 10),
                                  Text(
                                    "Are you sure to archive ${widget.branch.branchName}?",
                                    style: TextStyle(fontSize: 16),
                                  ),
                                  const SizedBox(height: 8),
                                  Text(
                                    "Archiving this branch will temporarily pause its operations. You can reactivate it later if needed.",
                                    style: TextStyle(
                                      fontSize: 14,
                                      fontStyle: FontStyle.italic,
                                      color: Colors.grey.shade600,
                                      ...
                                      TextButton(
                                        onPressed: () async {
                                          try {
                                            ...
                                            print(
                                                "Branch archived: ${widget.branch.id}");
                                            ...
                                            EasyLoading.instance
                                              ...
                                              ..dismissOnTap = true;
                                            EasyLoading.showToast(
                                              "${widget.branch.branchName} is successfully archived!",
                                              dismissOnTap: true,
                                              toastPosition:
                                        ...
                                        child: Text(
                                          'Yes, archive ${widget.branch.branchName}',
                                          style: TextStyle(color: Colors.white),
                                        ),
                                      ),
                                    ],
