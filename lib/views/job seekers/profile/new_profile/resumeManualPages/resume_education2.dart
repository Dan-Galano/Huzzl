...
class ResumePageEducation2 extends StatefulWidget {
  ...
  @override
  _ResumePageEducation2State createState() => _ResumePageEducation2State();
}

class _ResumePageEducation2State extends State<ResumePageEducation2> {
  ...
  void _submitEducation() {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        EducationSorter.sortEducationEntries(educationEntries);

        for (var entry in resumeProvider.education!) {
          print('Degree: ${entry.degree}');
          print('Institution Name: ${entry.institutionName}');
          print('Institution Address: ${entry.institutionAddress}');
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CustomTextFormField(
                                    ...
                                    validator: (value) {
                                      if (entry.institutionNameController.text
                                          .isEmpty) {
                                        return 'Required';
                                      }
                                      return null;
                                  ...
                                  CustomTextFormField(
                                    ...
                                    validator: (value) {
                                      if (entry.institutionAddressController
                                          .text.isEmpty) {
                                        return 'Required';
                                      }
                                      return null;
                                  ...
                                  CustomTextFormField(
                                    ...
                                    validator: (value) {
                                      if (entry.honorsOrAwardsController.text
                                          .isEmpty) {
                                        return 'Required';
                                      }
                                      return null;
