...
class DeniedDocumentsScreen extends StatefulWidget {
  const DeniedDocumentsScreen({super.key});

  @override
  State<DeniedDocumentsScreen> createState() => _DeniedDocumentsScreenState();
}

class _DeniedDocumentsScreenState extends State<DeniedDocumentsScreen> {
  @override
  ...
  Future<List<Map<String, dynamic>>> _fetchCompanyInformation(
    ...
    for (var user in users) {
      ...
      final companyInfoSnapshot = await FirebaseFirestore.instance
          ...
          .where('companyStatus', isEqualTo: 'denied')
          .get();
